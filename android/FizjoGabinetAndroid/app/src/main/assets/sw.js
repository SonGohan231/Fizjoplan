const CACHE='fizjogabinet-v7-category-pdfs';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data.js','./exercise-data.js','./exercise_library.json','./pdf_index.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
